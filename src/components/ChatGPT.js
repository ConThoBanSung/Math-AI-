...
const ChatGPT = () => {
    ...
    const fetchUserId = async () => {
      ...
      try {
        const res = await axios.post(
          "https://e683-14-241-224-21.ngrok-free.app/auth/verifyToken",
          { token },
  ...
  const saveChat = async () => {
    try {
      ...
      await axios.post(
        "https://e683-14-241-224-21.ngrok-free.app/auth/saveChat",
        payload,
  ...
  const updateProfile = async () => {
    try {
      const response = await axios.post(
        "https://e683-14-241-224-21.ngrok-free.app/auth/updateProfile",
        {
          userId,
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await axios.post(
        "https://e683-14-241-224-21.ngrok-free.app/generate",
        { prompt: input },
        {
          headers: {
